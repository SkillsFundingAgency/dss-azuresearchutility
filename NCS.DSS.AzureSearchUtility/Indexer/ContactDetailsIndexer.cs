...
{
    public static class ContactDetailsIndexer
    {
        ...
        public static async Task<HttpResponseMessage> RunUpdateContactDetailsIndexer(string searchAdminKey, SearchConfig searchConfig, SearchIndex customerSearchIndex)
        {
            Console.WriteLine("Retrieving Search Service for Contact Details Indexer\n");
